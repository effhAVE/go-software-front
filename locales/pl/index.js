export default {
  meta: {
    ...
    keywords: `programowanie, projektowanie, implementacja, wdrożenie, aplikacje, aplikacje, strony internetowe, ux, ui, kodowanie, figma, grafika, marketing, biznes, oprogramowanie, sklep internetowy, rozwój, usługi programistyczne, blog, wizytówka, pomysły, aplikacja internetowa, projektowanie stron internetowych, projektowanie mobilne, dokumentacja, rozwój oprogramowania, firma tworząca oprogramowanie, rozwój oprogramowania na zamówienie, firma tworząca aplikacje, rozwój aplikacji, oprogramowanie na zamówienie, strony internetowe lublin, programowanie lublin, programista lublin, projektant lublin, aplikacje internetowe lublin`,
  },
  navbar: {
    start: "Start",
    aboutus: "O nas",
  ...
  owners: {
    ...
    gkDesc: `Zajmuję się programowaniem, doborem technologii do projektów 
        oraz prowadzeniem firmy od strony prawno-finansowej. 
        Jako urodzony perfekcjonista, dążę do tego, by każdy piksel projektu graficznego 
        znalazł się we właściwym miejscu na stronie.`,
